...
void glueVars()
{
    ...
    bool_output_ptr[4][0] = (IEC_BOOL *)__QX4_0;
    
    bool_output_ptr[4][1] = (IEC_BOOL *)__QX4_1;
    
    bool_output_ptr[4][2] = (IEC_BOOL *)__QX4_2;
    
    bool_output_ptr[4][3] = (IEC_BOOL *)__QX4_3;
    
    bool_output_ptr[4][4] = (IEC_BOOL *)__QX4_4;
    
    bool_output_ptr[4][5] = (IEC_BOOL *)__QX4_5;
    
    int_memory_ptr[10] = (IEC_UINT *)__MW10;
